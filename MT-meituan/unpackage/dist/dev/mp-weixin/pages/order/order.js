...
//
//
var Tips = function Tips() {__webpack_require__.e(/*! require.ensure | tips/tips */ "tips/tips").then((function () {return resolve(__webpack_require__(/*! ../../tips/tips.vue */ 203));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { Tips: Tips }, data: function data() {return { showOrHide: false, tipText: '', openid: '' };}, methods: { ordering: function ordering() {// 发送请求
